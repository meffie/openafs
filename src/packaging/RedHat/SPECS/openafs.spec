...
# Specify '--with bitmap_later' to enable "bitmap later" support
%bcond_with bitmap_later

# Specify '--with supergroups' to enable "supergroups" support.
...
%systemd_post openafs-server.client
...
- Drop support for RHEL7 and older
